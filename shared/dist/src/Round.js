...
var RoundState;
(function (RoundState) {
    RoundState[RoundState["bidphase"] = 0] = "bidphase";
    RoundState[RoundState["inbetweenphase"] = 1] = "inbetweenphase";
    RoundState[RoundState["playphase"] = 2] = "playphase";
    RoundState[RoundState["done"] = 3] = "done";
})(RoundState || (RoundState = {}));
export default class Round {
    firstplayer;
    currentPlayer;
    hands;
    roundState = RoundState.bidphase;
    currentBid = new Bid(0, BidType.pass, NaN, NaN); // Default bid is a pass with no trump
    tricks = [];
    get CurrentPlayer() { return this.currentPlayer; }
    get RoundState() { return this.roundState; }
    get CurrentBid() { return this.CurrentBid; }
    get Hands() { return this.hands; }
    get Tricks() { return this.tricks; }
    constructor(firstplayer, hands = []) {
